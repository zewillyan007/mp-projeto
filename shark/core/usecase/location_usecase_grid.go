...
type LocationUseCaseGrid struct {
	repository port.LocationIRepository
}

func NewLocationUseCaseGrid(repository port.LocationIRepository) *LocationUseCaseGrid {
	return &LocationUseCaseGrid{repository: repository}
}

func (o *LocationUseCaseGrid) Execute(GridConfig *grid.GridConfig) map[string]interface{} {
