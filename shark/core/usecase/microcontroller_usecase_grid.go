...
type MicrocontrollerUseCaseGrid struct {
	repository port.MicrocontrollerIRepository
}

func NewMicrocontrollerUseCaseGrid(repository port.MicrocontrollerIRepository) *MicrocontrollerUseCaseGrid {
	return &MicrocontrollerUseCaseGrid{repository: repository}
}

func (o *MicrocontrollerUseCaseGrid) Execute(GridConfig *grid.GridConfig) map[string]interface{} {
